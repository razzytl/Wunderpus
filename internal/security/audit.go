...
// NewAuditLogger opens (or creates) the SQLite audit database using the shared audit DB connection.
func NewAuditLogger(db *sql.DB, encryptionKey []byte) (*AuditLogger, error) {
