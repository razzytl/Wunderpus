...
func (c *Calculator) Description() string  { return "Evaluate a mathematical expression. Supports +, -, *, /, parentheses, and common math functions (sqrt, pow, abs, sin, cos, tan, log, log2, log10, ceil, floor, round)." }
